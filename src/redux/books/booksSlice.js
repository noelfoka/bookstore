...
const URL_BOOKS = 'https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/InCbedF3E3EowoYTIuAc/books';
...
export const addBook = createAsyncThunk('books/addBook', async (bookData) => {
  ...
  const response = await axios.post(URL_BOOKS, res, { headers: { 'Content-Type': 'application/json' } });
